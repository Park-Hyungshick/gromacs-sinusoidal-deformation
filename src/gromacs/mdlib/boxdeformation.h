...
public:
    ...
    //! Get the deformation velocity at this \c step (for flow matrix calculation);
...
private:
    ...
    //! Type of deformation (no, linear, sinusoidal).
    DeformationType deformType_;
    ...
    //! Sinusoidal deformation amplitude (nm) for each box component.
    Matrix3x3 sinusoidalAmplitude_;
    //! Sinusoidal deformation period (ps) for each box component.
    Matrix3x3 sinusoidalPeriod_;
};
