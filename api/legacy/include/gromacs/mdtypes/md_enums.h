...
//! Enumeration for box deformation types
enum class DeformationType : int
{
    No,         //!< No deformation
    Linear,     //!< Linear deformation with constant rate
    Sinusoidal, //!< Sinusoidal deformation
    Count,
    Default = No
};
//! String corresponding to deformation type
const char* enumValueToString(DeformationType enumValue);
